...
```bash
git clone https://github.com/YOUR-USERNAME/JSFunFall2024.git
```

Git may prompt you to login using a browser like Chrome, Edge, or Safari. If asked, authorize the OAuth app.
...
git remote add upstream https://github.com/AlbanyCanCodeCourses/JSFunFall2024
git remote -v
# You should see your upstream set as https://github.com/AlbanyCanCodeCourses/JSFunFall2024.git
```
